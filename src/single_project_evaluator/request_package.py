...
EVALUATION_INSTRUCTIONS = [
    ...
    "Use evidence entries starting with 'uncertainty:' for explicit evidence limits; do not use uncertainty-only evidence for Required/Unsatisfied findings.",
    ...
    "findings": [
        {
            ...
            "evidence": ["file paths, snippets, records, or explicit uncertainty prefixed with 'uncertainty:'"],
        ...
        "findings": [
            {
                ...
                "applicability": None,
                "evidence": ["path or evidence reference; use 'uncertainty: ...' only for explicit evidence limits"],
                "impact": "Why this matters.",
                "consequence": "What follows from the evidence.",
                "recommendation": None,
            }
